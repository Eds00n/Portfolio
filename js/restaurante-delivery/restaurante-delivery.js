...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	function ac(e, t, n, r) {
		...
		o !== null && typeof o.componentDidCatch == "function" && (e.callback = function() {
			nc(t, n, r), typeof i != "function" && (iu === null ? iu = /* @__PURE__ */ new Set([this]) : iu.add(this));
			var e = r.stack;
	...
	function oc(e, t, n, r, i) {
		if (n.flags |= 32768, typeof r == "object" && r && typeof r.then == "function") {
			if (t = n.alternate, t !== null && oa(t, n, i, !0), n = uo.current, n !== null) {
				switch (n.tag) {
					case 31:
					case 13: return fo === null ? Du() : n.alternate === null && Y === 0 && (Y = 3), n.flags &= -257, n.flags |= 65536, n.lanes = i, r === Ma ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = /* @__PURE__ */ new Set([r]) : t.add(r), Gu(e, r, i)), !1;
	...
	n(), t.exports = s();
})), l = i(), u = c(), d = (e) => `assets/restaurante/${e}`, f = {
	...
	image: d("hero-burger.jpg"),
	imageAlt: "Combo X-Burger com batata frita"
}, p = [
	{
		id: "hamburguer",
		label: "Hambúrguer",
		image: d("cat-hamburger.jpg"),
		imageAlt: "Hambúrguer artesanal"
	},
	{
		id: "lanches",
		label: "Lanches",
		image: d("cat-lanche.jpg"),
		imageAlt: "Lanche com batata"
	},
	{
		id: "pizzas",
		label: "Pizzas",
		image: d("cat-pizza.jpg"),
		imageAlt: "Pizza fatia"
	},
	{
		id: "massas",
		label: "Massas",
		image: d("cat-pasta.jpg"),
		imageAlt: "Massa ao molho"
	},
	{
		id: "bebidas",
		label: "Bebidas",
		image: d("cat-drink.jpg"),
		imageAlt: "Bebida gelada"
	},
	{
		id: "sobremesas",
		label: "Sobremesas",
		image: d("cat-dessert.jpg"),
		imageAlt: "Sobremesa"
	}
], m = [
	{
...
m.filter((e) => h.includes(e.id));
function g(e) {
	return e ? m.filter((t) => t.categoria === e) : m.filter((e) => h.includes(e.id));
}
function _(e) {
	return e ? p.find((t) => t.id === e)?.label ?? "Cardápio" : "Mais vendidos";
}
//#endregion
...
var v = /* @__PURE__ */ e(((e) => {
	...
	t.exports = v();
})))(), b = (0, l.memo)(function({ src: e, alt: t, className: n = "", priority: r = !1, sizes: i }) {
...
}), x = "h-[18px] w-[18px] shrink-0";
function ee({ className: e = x }) {
	return /* @__PURE__ */ (0, y.jsx)("svg", {
		className: e,
		viewBox: "0 0 24 24",
		fill: "currentColor",
		"aria-hidden": !0,
		children: /* @__PURE__ */ (0, y.jsx)("path", { d: "M12 2.5 14.8 9h7.2l-5.8 4.2 2.2 7-7.4-4.8L4.8 20.2l2.2-7L1.2 9h7.2L12 2.5Z" })
	});
}
function S({ className: e = x }) {
	return /* @__PURE__ */ (0, y.jsxs)("svg", {
		...
		children: [
			...
			/* @__PURE__ */ (0, y.jsx)("path", {
				d: "M2 3h2l2.2 11.4a1 1 0 0 0 1 .8h9.6a1 1 0 0 0 1-.8L20 8H6",
				strokeLinejoin: "round"
			})
		]
	});
}
function C({ className: e = x }) {
	return /* @__PURE__ */ (0, y.jsx)("svg", {
		className: e,
		viewBox: "0 0 24 24",
		fill: "none",
...
//#endregion
//#region src/components/HeroPromo.jsx
var te = (0, l.memo)(function() {
	let [e, t] = (0, l.useState)(!1), n = (0, l.useCallback)(() => {
		t(!0), window.setTimeout(() => t(!1), 400);
	}, []);
	return /* @__PURE__ */ (0, y.jsxs)("section", {
		className: "relative overflow-hidden rounded-lg border border-ink/12 bg-cream-dark",
		children: [
			/* @__PURE__ */ (0, y.jsx)("div", {
				className: "relative z-10 flex min-h-[210px] flex-col justify-center px-5 py-7 sm:min-h-[230px] sm:px-7 sm:py-9 lg:max-w-[55%] lg:px-8",
				children: /* @__PURE__ */ (0, y.jsxs)("div", {
					className: "delivery-hero__content",
					children: [
						/* @__PURE__ */ (0, y.jsx)("span", {
							className: "delivery-hero__badge rounded-full border border-ink/15 bg-cream text-[10px] font-bold uppercase tracking-wider text-ink-muted",
							children: f.badge
						}),
						/* @__PURE__ */ (0, y.jsxs)("div", {
							className: "delivery-hero__copy",
							children: [/* @__PURE__ */ (0, y.jsxs)("h2", {
								className: "delivery-hero__title text-2xl font-black uppercase text-ink sm:text-[1.75rem]",
								children: [/* @__PURE__ */ (0, y.jsx)("span", {
									className: "delivery-hero__title-line",
									children: f.title[0]
								}), /* @__PURE__ */ (0, y.jsx)("span", {
									className: "delivery-hero__title-line",
									children: f.title[1]
								...
								className: "delivery-hero__description text-xs text-ink-muted sm:text-[13px]",
								children: f.description
							})]
						}),
						/* @__PURE__ */ (0, y.jsxs)("div", {
							className: "delivery-hero__actions",
							children: [/* @__PURE__ */ (0, y.jsxs)("div", {
								className: "delivery-hero__pricing",
								children: [/* @__PURE__ */ (0, y.jsx)("span", {
									className: "text-sm text-ink-muted/60 line-through",
									children: f.priceOld
								}), /* @__PURE__ */ (0, y.jsx)("span", {
									className: "text-xl font-black text-ink",
									children: f.priceCurrent
								})]
							}), /* @__PURE__ */ (0, y.jsxs)("button", {
								type: "button",
								className: ["delivery-btn-primary delivery-tap border border-ink bg-ink text-xs font-bold uppercase tracking-wide text-cream transition-all duration-200 hover:bg-ink/90 hover:scale-[1.02]", e ? "delivery-pop bg-accent border-accent" : ""].join(" "),
								onClick: n,
								children: [/* @__PURE__ */ (0, y.jsx)(S, { className: "h-4 w-4 shrink-0" }), "Pedir agora"]
							})]
						})
					]
				})
			...
			/* @__PURE__ */ (0, y.jsxs)("div", {
				className: "absolute inset-y-0 right-0 w-[48%] sm:w-[44%]",
				...
				}), /* @__PURE__ */ (0, y.jsx)("div", { className: "absolute inset-0 bg-linear-to-r from-cream-dark via-cream-dark/85 to-transparent" })]
			}),
			/* @__PURE__ */ (0, y.jsxs)("div", {
				className: "absolute bottom-3 right-4 z-20 flex gap-1.5",
				"aria-hidden": !0,
				children: [
					/* @__PURE__ */ (0, y.jsx)("span", { className: "h-1.5 w-4 rounded-full bg-ink" }),
					/* @__PURE__ */ (0, y.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-ink/20" }),
					/* @__PURE__ */ (0, y.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-ink/20" })
				]
			})
		]
	});
}), ne = (0, l.memo)(function({ categoriaAtiva: e, onCategoriaClick: t, onVerTodas: n }) {
	return /* @__PURE__ */ (0, y.jsxs)("section", {
		"aria-labelledby": "categorias-heading",
		children: [/* @__PURE__ */ (0, y.jsxs)("div", {
			className: "mb-4 grid grid-cols-[1fr_auto_1fr] items-center gap-3",
			children: [
				...
				/* @__PURE__ */ (0, y.jsx)("button", {
					type: "button",
					className: ["delivery-btn-link delivery-tap justify-self-end text-xs font-semibold transition-colors duration-200 hover:underline", e ? "text-accent" : "text-ink-muted"].join(" "),
					onClick: n,
					children: "Ver todas"
				})
			]
			...
			children: p.map((n) => {
				...
				return /* @__PURE__ */ (0, y.jsxs)("button", {
					...
					role: "tab",
					"aria-selected": r,
					className: ["delivery-tap group flex flex-col items-center gap-2 text-center transition-transform duration-300", r ? "scale-105" : "hover:scale-[1.03]"].join(" "),
					onClick: () => t(n.id),
					children: [/* @__PURE__ */ (0, y.jsx)("span", {
						className: ["relative h-14 w-14 overflow-hidden rounded-full border bg-cream transition-all duration-300 sm:h-16 sm:w-16", r ? "border-ink shadow-sm ring-2 ring-ink/15" : "border-ink/12 group-hover:border-ink/30"].join(" "),
						children: /* @__PURE__ */ (0, y.jsx)(b, {
							src: n.image,
							alt: n.imageAlt ?? n.label,
							className: ["h-full w-full object-cover transition-transform duration-300", r ? "scale-110" : "group-hover:scale-105"].join(" "),
							sizes: "64px"
						})
					}), /* @__PURE__ */ (0, y.jsx)("span", {
						className: ["text-[10px] font-semibold leading-tight transition-colors duration-300 sm:text-[11px]", r ? "text-ink" : "text-ink-muted group-hover:text-ink/80"].join(" "),
						children: n.label
					})]
				}, n.id);
			})
...
}), re = (0, l.memo)(function({ produto: e }) {
	let [t, n] = (0, l.useState)(!1), r = (0, l.useCallback)(() => {
		n(!0), window.setTimeout(() => n(!1), 380);
	}, []);
	return /* @__PURE__ */ (0, y.jsxs)("article", {
		className: "delivery-product-card group overflow-hidden rounded-lg border border-ink/12 bg-cream transition-shadow duration-300 hover:shadow-sm",
		children: [/* @__PURE__ */ (0, y.jsxs)("div", {
			className: "relative aspect-4/3 overflow-hidden bg-cream-dark",
			children: [/* @__PURE__ */ (0, y.jsx)(b, {
				src: e.image,
				alt: e.imageAlt ?? e.nome,
				className: "h-full w-full object-cover transition-transform duration-300 group-hover:scale-105",
				sizes: "(min-width: 640px) 25vw, 50vw"
			}), /* @__PURE__ */ (0, y.jsx)("button", {
				type: "button",
				className: ["delivery-tap absolute bottom-2 right-2 flex h-8 w-8 items-center justify-center rounded-full border border-ink/12 bg-cream text-ink shadow-sm hover:scale-105 hover:border-ink/25", t ? "delivery-pop" : ""].join(" "),
				"aria-label": `Adicionar ${e.nome}`,
				onClick: r,
				children: /* @__PURE__ */ (0, y.jsx)(C, { className: "h-4 w-4" })
			})]
		}), /* @__PURE__ */ (0, y.jsxs)("div", {
			className: "p-2.5 sm:p-3",
			children: [/* @__PURE__ */ (0, y.jsx)("p", {
				className: "truncate text-xs font-bold text-ink sm:text-[13px]",
				children: e.nome
			}), /* @__PURE__ */ (0, y.jsxs)("div", {
				className: "mt-1 flex items-center justify-between gap-1",
				children: [/* @__PURE__ */ (0, y.jsxs)("span", {
					className: "inline-flex items-center gap-0.5 text-[10px] font-semibold text-ink-muted",
					children: [/* @__PURE__ */ (0, y.jsx)(ee, { className: "h-3 w-3 text-accent" }), e.rating]
				}), /* @__PURE__ */ (0, y.jsx)("span", {
					className: "text-xs font-black text-ink",
					children: e.preco
				})]
			})]
		})]
	});
}), w = (0, l.memo)(function({ titulo: e, produtos: t, panelAnim: n = "", titleAnim: r = "" }) {
	let i = (0, l.useMemo)(() => ["mx-auto grid gap-3", t.length >= 4 ? "max-w-md grid-cols-2 sm:max-w-3xl sm:grid-cols-4" : "max-w-md grid-cols-2 sm:max-w-xl sm:grid-cols-3"].join(" "), [t.length]);
	return /* @__PURE__ */ (0, y.jsxs)("section", {
		className: "mt-6",
		"aria-labelledby": "produtos-heading",
		children: [/* @__PURE__ */ (0, y.jsx)("h3", {
			id: "produtos-heading",
			className: ["delivery-section-heading text-center text-sm font-black uppercase tracking-wide text-ink", r].join(" "),
			children: e
		}), /* @__PURE__ */ (0, y.jsx)("div", {
			className: "delivery-grid-viewport",
			children: /* @__PURE__ */ (0, y.jsx)("div", {
				className: n,
				children: t.length === 0 ? /* @__PURE__ */ (0, y.jsx)("p", {
					className: "text-center text-sm text-ink-muted",
					children: "Nenhum item nesta categoria."
				}) : /* @__PURE__ */ (0, y.jsx)("div", {
					className: i,
					children: t.map((e) => /* @__PURE__ */ (0, y.jsx)(re, { produto: e }, e.id))
				})
			})
		})]
	});
}), ie = 280, ae = p.map((e) => e.id);
function oe(e, t) {
	if (e === t || e === null) return "next";
	if (t === null) return "prev";
	let n = ae.indexOf(e), r = ae.indexOf(t);
	return n === -1 || r === -1 || r > n ? "next" : "prev";
}
function se() {
	return typeof window > "u" ? !1 : window.matchMedia("(prefers-reduced-motion: reduce)").matches;
}
function ce() {
	let [e, t] = (0, l.useState)(null), [n, r] = (0, l.useState)(null), [i, a] = (0, l.useState)(""), [o, s] = (0, l.useState)(""), c = (0, l.useRef)(!1), u = (0, l.useRef)(null), d = (0, l.useRef)([]);
	u.current = e, (0, l.useEffect)(() => () => {
		d.current.forEach((e) => window.clearTimeout(e)), d.current = [];
	}, []);
	let f = (0, l.useCallback)((e, t) => {
		let n = window.setTimeout(e, t);
		return d.current.push(n), n;
	}, []), p = (0, l.useCallback)((e) => {
		if (e === u.current || c.current) return;
		if (se()) {
			t(e), r(e);
			return;
		}
		let n = oe(u.current, e);
		c.current = !0, t(e), a(`delivery-slide-out-${n}`), s("delivery-title-out"), f(() => {
			r(e), a(`delivery-slide-in-${n}`), s("delivery-title-in"), f(() => {
				a(""), s(""), c.current = !1;
			}, ie);
		}, ie);
	}, [f]);
	return {
		...
		panelAnim: i,
		titleAnim: o,
		handleCategoriaClick: (0, l.useCallback)((e) => {
			p(u.current === e ? null : e);
		}, [p]),
		handleVerTodas: (0, l.useCallback)(() => {
			p(null);
		}, [p])
	};
}
//#endregion
//#region src/components/RestauranteDeliveryMockup.jsx
var le = (0, l.memo)(function() {
	let { categoriaAtiva: e, displayCategoria: t, panelAnim: n, titleAnim: r, handleCategoriaClick: i, handleVerTodas: a } = ce(), o = (0, l.useMemo)(() => g(t), [t]), s = (0, l.useMemo)(() => _(t), [t]);
	return /* @__PURE__ */ (0, y.jsxs)("div", {
		className: "delivery-mockup",
		children: [/* @__PURE__ */ (0, y.jsx)(te, {}), /* @__PURE__ */ (0, y.jsxs)("div", {
...
function T(e) {
	if (!e) return;
	E(e);
	let t = (0, u.createRoot)(e, { onUncaughtError: (e) => console.error("Restaurante Delivery:", e) });
	ue.set(e, t), t.render(/* @__PURE__ */ (0, y.jsx)(le, {}));
}
function E(e) {
	if (!e) return;
	let t = ue.get(e);
	t && (t.unmount(), ue.delete(e), e.innerHTML = "");
}
//#endregion
export { T as mountRestauranteDeliveryMockup, E as unmountRestauranteDeliveryMockup };
